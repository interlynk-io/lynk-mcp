...
.PHONY: configure
configure: build ## Configure the server
	@echo "Running $(BINARY_NAME) configure..."
	@$(BUILD_DIR)/$(BINARY_NAME) configure

.PHONY: check
check: build ## Verify connection
	@echo "Running $(BINARY_NAME) verify..."
